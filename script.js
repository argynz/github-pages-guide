...
const quizQuestions = [
  { question: "Для чего нужен Git?", answers: ["Для сохранения истории изменений проекта", "Для оплаты сервиса", "Для создания паролей"], correct: 0 },
  { question: "Что такое репозиторий?", answers: ["Папка проекта на GitHub вместе с историей изменений", "Программа для оплаты сервиса", "Вид операционной системы"], correct: 0 },
  ...
  { question: "Что делает GitHub Pages?", answers: ["Публикует сайт из файлов репозитория", "Устанавливает Git", "Создаёт аккаунт ChatGPT"], correct: 0 },
  ...
  { question: "Для чего нужен GitHub CLI?", answers: ["Чтобы удобнее подключаться к GitHub и работать с проектами через команды", "Чтобы оформить аккаунт ChatGPT", "Чтобы поменять операционную систему"], correct: 0 },
